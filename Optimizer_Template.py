...
optimizer.load_players_from_csv(r"E:\Drive_William\Optimizer_CSVs\Optimizer(inputs)\Scrape Csv\01-27-21\Fanduel1.csv")
...
#print & export
for lineup in optimizer.optimize(n=100, exposure_strategy=AfterEachExposureStrategy):
    print(lineup)
